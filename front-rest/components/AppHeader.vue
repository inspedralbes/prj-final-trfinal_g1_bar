<template>
    <PrimeToolbar>
        <template #start>
            <PrimeSidebar class="sidebar" v-model:visible="visible">
                <template #container="{ closeCallback }">
                    <div class="flex flex-column h-full">
                        <div
                            class=" sidebarItemClose flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0">
                            <span>
                                <PrimeButton type="button" @click="closeCallback" icon="pi pi-times" rounded outlined
                                    class="h-2rem w-2rem">
                                        ...
                                        <div @click="Rpush('/crearQR')">
                                            <div class="sidebarItem">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-qrcode" width="44" height="44"
                                ...
                                <li>
                                    <a v-ripple
                                        ...
                                        <div @click="Rpush('/llistat')">
                                            <div class="sidebarItem">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-clipboard-list" width="44"
                                                    height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff"
                                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <path
                                ...
                                <li>
                                    <a v-ripple
                                        ...
                                        <div @click="Rpush('/llistatCuina')">
                                            <div class="sidebarItem">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-sticker-2" width="44" height="44"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" fill="none"
                                                    stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <path
...
.sidebar {
    ...
    position: fixed;
    /* Fix the sidebar to the left of the screen */
    left: 0;
    /* Position the sidebar at the left edge of the screen */
    top: 0;
    /* Position the sidebar at the top edge of the screen */
    background-color: #333;
    /* Background color of the sidebar */
    overflow-x: hidden;
    /* Prevent horizontal scrolling */
    padding-top: 20px;
    /* Padding at the top of the sidebar */
    transition: 0.5s;
    /* Transition effect when the sidebar is toggled */
    color: #fff;
    /* Text color */
}
...
.sidebar a {
    ...
    transition: 0.3s;
    /* Transition effect when hovering over links */
}
...
.sidebar a:hover {
    color: #f1f1f1;
    /* Color of links when hovered over */
}
