...
export const restaurantSlice = createSlice({
  ...
  reducers: {
    ...
    setProducteSelecctionat(state, action: PayloadAction<any>) {
      state.producteSeleccionat = action.payload;
    },
...
export const { setRestaurantId, setTiquetId, setCategoriaId, setProductesCategoriaVisualitzada, setProducteSelecctionat, 
